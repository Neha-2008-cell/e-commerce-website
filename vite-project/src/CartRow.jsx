          ...
          {products.map(function (props) {
                return (
                    <div className=" flex items-center gap-20 mb-1 w-270 mx-15  p-5" key={props.id}>
                       <div className="flex gap-8 w-100  mr-30 items-center ">
                        ...
                        <div className="flex justify-end mb-1 items-center font-bold gap-20">
                        <p ><div className=" w-20">${props.price}</div></p>
                        ...
                        <p  className="ml-5">${localCart[props.id] * props.price }</p>
                       </div>
                    </div>
